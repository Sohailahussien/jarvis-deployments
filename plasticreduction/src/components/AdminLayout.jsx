      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-700">
          {!sidebarCollapsed && (
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-white">Sarooj Admin</span>
            </div>
          )}
          <button
            onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
            className="p-2 text-slate-400 hover:text-white hover:bg-slate-700 rounded-lg hidden lg:block"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              {sidebarCollapsed ? (
        ...
        <div className="p-4 border-t border-slate-700">
          ...
          {sidebarCollapsed && (
            <button
              onClick={handleLogout}
              className="w-full mt-3 p-2 text-slate-400 hover:text-red-400 hover:bg-slate-700 rounded-lg"
              title="Logout"
            >
        ...
        <header className="h-16 bg-slate-800 border-b border-slate-700 flex items-center justify-between px-4 lg:px-6">
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2 text-slate-400 hover:text-white hover:bg-slate-700 rounded-lg lg:hidden"
            >
